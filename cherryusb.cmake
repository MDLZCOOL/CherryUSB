...
if(CONFIG_CHERRYUSB_HOST)
    ...
    if(CONFIG_CHERRYUSB_HOST_SERIAL)
        list(APPEND cherryusb_srcs ${CMAKE_CURRENT_LIST_DIR}/class/vendor/serial/usbh_serial.c)
    endif()
    if(CONFIG_CHERRYUSB_HOST_SERIAL_CDC_ACM)
        list(APPEND cherryusb_srcs ${CMAKE_CURRENT_LIST_DIR}/class/vendor/serial/usbh_serial_cdc_acm.c)
    endif()
